package com.mitnick.tannotour.easylib.lifecycle;
...
public class LifecycleDispatcher implements ActivityLifecycleCallbacksCompat, FragmentLifecycleCallbacks {
    ...
    public static void registerLifecycleCallbacks(@Nullable Application application, ActivityLifecycleCallbacksCompat aCallback, FragmentLifecycleCallbacks fCallback){
        if(null == application){
            return;
        }
        registerActivityLifecycleCallbacks(application, aCallback);
        registerFragmentLifecycleCallbacks(application, fCallback);
    }
